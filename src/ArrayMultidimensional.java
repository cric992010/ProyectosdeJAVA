public class ArrayMultidimensional {
    public static void main(String[] args) {
        ...
        System.out.println("El resultado de multiplicar 4 por 5 esta en la prosicion [4][5] " + tablaDeMultiplicacion[4][5]);

        int miArrayMultidemensiona[][] = {{2, 5, -9},{-7, 25, 0}, {8, 3, 4}, {5,-6,86,69, 287}};
    }
}
